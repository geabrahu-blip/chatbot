...
async function sendMessengerText(senderPsid, text) {
    try {
        await axios_1.default.post(`https://graph.facebook.com/v18.0/me/messages?access_token=${PAGE_ACCESS_TOKEN}`, {
...
async function sendWhatsAppNotification(messageText) {
    try {
        await axios_1.default.post(`https://graph.facebook.com/v18.0/${WA_PHONE_NUMBER_ID}/messages`, {
...
async function sendPrivateReply(commentId, text) {
    try {
        await axios_1.default.post(`https://graph.facebook.com/v18.0/${commentId}/private_replies?access_token=${PAGE_ACCESS_TOKEN}`, { message: text });
    }
    catch (error) {
